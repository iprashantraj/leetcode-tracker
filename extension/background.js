...
// Run/Submit detection lives in extension/page-hook.js (main-world content
// script that hooks the page's own fetch + XHR). It posts a message into the
// page window, content.js relays it here via chrome.runtime.sendMessage.
